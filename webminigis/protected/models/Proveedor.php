...
class Proveedor extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('tipoPersona', 'numerical', 'integerOnly'=>true),
			...
			array('idProveedor, nombre, tipoPersona, RUC, direccion, telefono', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('tipoPersona',$this->tipoPersona);
